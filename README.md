...
├── L2\_data\_exploration.ipynb          # Data extraction from BigQuery

├── L3\_automation.ipynb                 # Kubeflow Pipelines (Google Cloud attempt)

├── L3\_openai\_finetuning.ipynb         # Fine-tuning attempts (4x, all failed)

├── L4\_predictions.ipynb                # Working application ✅

├── tune\_data\_\*.jsonl                   # Training data (10K Q\&As)
...
jupyter notebook L4\_predictions.ipynb
